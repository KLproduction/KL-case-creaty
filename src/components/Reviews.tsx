    ...
    return (
      <div
        ...
        {reviews.concat(reviews).map((imgSrc, reviewIndex) => (
          <Review key={reviewIndex} className={reviewClassName?.
...
function Review({imgSrc,className,...props}:ReviewProps){
    ...
    return <div className={cn('animate-fade-in rounded-[2.25rem] bg-white p-6 opacity-0 shadow-x shadow-slate-900/5', className)}
...
function ReviewGrid() {
    ...
    return (
        ...
        <>
            ...
            <div className="  absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-slate-100 "/>
            <div className="  absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-slate-100 "/>
...
export function Reviews() {
    return (
        <MaxWidthWrapper className="relative max-w-5xl">
            <img src="/what-people-are-buying.png" alt="" aria-hidden="true" 
